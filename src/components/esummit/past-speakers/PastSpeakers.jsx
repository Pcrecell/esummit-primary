    ...
    >
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <div className="w-full mb-2 md:mt-40 text-left px-6 md:px-12 lg:pl-24">
          ...
          <div
            className={`absolute fade-mask fade-bottom overflow-hidden ${isMobile ? "top-48" : "top-0 right-0"
              }`}
            style={{
              height: "100vh",
                ...
                <div className="flex gap-6 animate-marquee">
                  {[...speakers, ...speakers].map((speaker, idx) => (
                    <div
                      ...
                      style={{ width: "12rem" }} // same as w-48
                    >
                      <Image
                        src={speaker.image}
                        alt={speaker.alt}
      ...
      .animate-marquee {
        display: flex;
        min-width: max-content; /* ensures track fits all items in one line */
