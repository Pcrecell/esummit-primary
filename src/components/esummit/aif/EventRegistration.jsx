  ...
  return (
    <div className="relative flex items-center justify-center w-full bg-black/0 ">
      ...
      <div className="relative max-w-2xl w-full hidden md:flex items-center justify-center md:min-h-[600px] bg-transparent">
        ...
        {/* Title */}
        <div
          className={`absolute ${alreadyRegistered ? "top-33" : "top-28"} left-0 right-0 z-20 text-center px-4`}
        >
          <h1
          ...
          <div className="w-full h-full">
            {!alreadyRegistered ? (
              ...
              <div className="flex flex-col w-full items-center justify-start mb-24">
                ...
                <div>
                  <b>Registered At:</b>{" "}
                  {new Date(registeredData.registeredAt).toLocaleString(
                    "en-US",
                    {
                      year: "numeric",
                      month: "long",
                ...
                <div className="mt-10 w-full flex flex-col gap-3 justify-center items-center">
                  <p className="text-center">
                    Join our Discord server to participate in the event and for
                ...
                >
                  <p className="text-xs text-[#e5b913] -translate-y-2 underline justify-center items-center cursor-pointer hover:text-[#b5971b] transition-colors duration-300">
            ...
            <div className="flex justify-center mt-8">
              {alreadyRegistered ? (
                <div>
                  ...
                  >
                    <p className="text-xs text-[#e5b913] text-center underline cursor-pointer hover:text-[#b5971b] transition-colors duration-300">
                      Unregister from this event
                    </p>
                  </div>
                </div>
