...
const SidebarIcon = ({ 
  ...
  discordLink = "https://discord.gg/ZFRdAcxay8",
  bgColor = "black" 
}) => {
  ...
  const getBgClasses = (variant = 'default') => {
    const colorMap = {
      ...
      gold: {
        default: 'bg-black border-[#f7e355]',
        panel: 'bg-black border-[#f7e355]',
        hover: 'hover:bg-[#c4b01b]'
      }
    };
  ...
  return (
    <>
      ...
      <div className="hidden md:block">
        {/* Main Icon */}
        <div className={`fixed right-[-10]  border border-[#f7e355] top-1/2 transform -translate-y-1/2 z-50`}>
          <button
          ...
          >
            <Users className="w-5 h-5 text-[#f7e355]" />
            <span className="text-[#f7e355] font-medium text-sm whitespace-nowrap">
              Any Queries?
            </span>
          </button>
        </div>
        ...
        >
          <div className="h-full flex flex-col">
              ...
              <div className="space-y-8">
                ...
                <div className="text-center space-y-4">
                  <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto">
                    <MessageCircle className="w-8 h-8 text-[#f7e355]" />
                  </div>
                  <div>
                    ...
                    <p className={`${getSubtextClasses()} leading-relaxed`}>
                      Have questions? Join our Discord and WhatsApp communities to get them answered.
                    </p>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-purple-400 to-purple-500 hover:from-purple-600 hover:to-purple-700 text-white font-semibold py-4 px-6 rounded-xl flex items-center justify-center space-x-3 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
                >
            ...
            <div className={`px-8 py-4 border-t border-[#f7e355]`}>
      ...
      {/* Mobile Version */}
      <div className="md:hidden fixed bottom-12 right-[-5] z-50">
        <button
        ...
        >
          <div className="flex items-center ">
            <span className="text-[#f7e355] font-medium text-sm">
              Any Queries?
            </span>
          </div>
        </button>
