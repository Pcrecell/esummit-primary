...
const Guidelines = () => {
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="relative z-10 hidden md:flex items-center justify-between h-screen px-8 md:px-16 lg:px-24">
        {/* Single yellowish background panel behind the left text (desktop only) */}
        <div
          className="absolute left-0 top-1/2 -translate-y-1/2 h-[82vh] w-[62vw] max-w-[980px] -ml-20 rounded-r-[999px] bg-[#9E8851]/14 border border-[#9E8851]/35 pointer-events-none select-none z-0"
        />
...
<div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-black via-black/60 to-transparent z-10" />
        ...
        <div className="w-1/2 space-y-6 text-[#CDAF5B]">
          <ul className="space-y-4 text-base md:text-lg lg:text-xl font-medium tracking-wide">
            <li className="flex items-start">
              <svg className="w-3 h-3 text-[#31B34D] mt-2 mr-4 flex-shrink-0" viewBox="0 0 10 10" fill="currentColor" aria-hidden="true">
        ...
        <div className="w-1/2 flex justify-center items-center relative z-10">
          <h1 className="text-5xl md:text-6xl lg:text-7xl xl:text-7xl md:pl-[25vw] font-bold text-[#CDAF5B] select-none tracking-wider drop-shadow-[0_2px_2px_rgba(0,0,0,0.6)]">
            GUIDELINES
          </h1>
        </div>
      ...
      <div className="md:hidden relative z-10 flex flex-col min-h-screen px-6 py-8 space-y-6">
        {/* Mobile Heading */}
        <h1 className="text-3xl font-bold text-[#9E8851] select-none tracking-wider mb-4">
          GUIDELINES
        </h1>
        ...
        <div className="space-y-4 text-[#CDAF5B]">
          <ul className="space-y-4 text-sm font-medium tracking-wide">
            <li className="flex items-start">
              <svg className="w-3 h-3 text-[#31B34D] mt-1.5 mr-4 flex-shrink-0" viewBox="0 0 10 10" fill="currentColor" aria-hidden="true">
                <polygon points="0,5 10,0 10,10" />
              </svg>
              <span>
                Participants must form teams comprising 3 to 5 members. Collaboration is key - diverse minds bring bold solutions.
