            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden">
                ...
                <div className="absolute inset-0 z-30 flex items-center justify-center">
                  <span className={`${poppins.className} text-white font-semibold text-sm sm:text-base md:text-lg lg:text-xl transition-all group-hover:-translate-y-0.5 tracking-wide pointer-events-none select-none drop-shadow-[0_1px_1px_rgba(0,0,0,0.6)]`}>
                    Register Now
                  </span>
                </div>
              </div>
