...
const initialEvents = [
  {
    ...
    date: "23.08.25",
    time: "9.00AM-3.00PM",
    desc: " The signature blind pitching event of KIIT E-Cell that embodies adaptability and creativity.Challenges are revealed seconds before you pitch your idea, heaping a good dose of wit and confidence onto the task.Oracle is all about quick thinking and the art of persuasion, all under the pressure of collaborative performance.Everyone has a chance to win, from gutsy newbies to seasonedÂ professionals.",
  ...
  },
  {
    ...
    date: "24.08.25",
    time: "9.00AM-3.00PM",
    desc: "The ultimate battleground created by KIIT E-Cell for future strategists and problem solvers.Youâ€™ll wrestle with actual business challenges using critical thinking and unique strategies.In a team format, you will illustrate your teamwork, business insight, and consulting vibe in a competitive environment.Each pitch is your breakthrough inÂ theÂ boardroom.",
  ...
  },
  {
    ...
    time: "9.00AM-4.30PM",
    desc: "KIIT E-Cellâ€™s flagship hackathon where ideas meet impact.In 72 hours, participants take on real-world challenges guided by experienced mentors.Our unique two-tier system makes this arena accessible to everyone - from amateurs to experts.Innovation, resources, and rewards - allÂ onÂ oneÂ stage.",
