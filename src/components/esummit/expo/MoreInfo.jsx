    ...
    <div className="w-full">
      ...
      >
        ...
        <div className="p-3 sm:p-6 lg:p-10">
          <div className="grid grid-cols-2 gap-4 sm:gap-8 lg:gap-12">
            {/* Category Column */}
            <div>
              <h2 className="text-sm sm:text-xl md:text-2xl lg:text-3xl font-bold text-white mb-3 sm:mb-6 lg:mb-8">
                CATEGORY
              </h2>
              <div className="space-y-2 sm:space-y-4 lg:space-y-6">
                <div className="text-white text-xs sm:text-base md:text-lg lg:text-xl font-semibold">
      ...
      >
        ...
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-white text-lg sm:text-xl md:text-2xl lg:text-xl font-semibold mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
            ...
            <div className="space-y-4 sm:space-y-6 lg:space-y-15">
              <div className="flex items-start space-x-3">
                ...
                <div className="text-white text-sm sm:text-base md:text-lg lg:text-xl font-semibold">
        ...
        <div className="p-3 sm:p-6 lg:p-10">
          <div className="max-w-5xl mx-auto space-y-6 sm:space-y-8 lg:space-y-10">
            ...
            <div className="flex items-start space-x-4">
              <div className="text-white text-lg sm:text-xl lg:text-2xl mt-1">•</div>
              <div className="text-white text-sm sm:text-base md:text-lg lg:text-xl font-semibold leading-relaxed">
      ...
      >
        ...
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-8" style={{ color: '#FFD289' }}>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
              ...
              <div>
                ...
                <div className="space-y-4 sm:space-y-6 lg:space-y-8">
                  <div className="text-white text-xs sm:text-base md:text-lg lg:text-xl font-semibold text-center">
      ...
      {/* Day 2 Timeline Section */}
      <InfoSection 
        backgroundImage="https://ik.imagekit.io/admr8uj75/Frame%20264.png?updatedAt=1755083037338"
        sectionId="day2-timeline"
      >
        {/* Main Heading */}
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          <h2 className="text-white text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-8" style={{ color: '#FFB641' }}>
