    ...
    >
      <div className="flex items-center gap-8 flex-grow">
        <a href="https://kiitecell.org" className="flex items-center px-2 py-1">
          ...
          <Image
            src={
              "https://ik.imagekit.io/ecellkiit/E-Cell%20Website/ecell-logo.png?updatedAt=1755075880401"
            }
            alt="logo"
            width={50}
            height={50}
  ...
  return (
    ...
    >
      {items.map((item, idx) => {
        ...
        const isActive = hovered === globalIdx || clicked === globalIdx;
  ...
  return (
    <a href="/">
      <button className="flex items-center px-2 py-1">
        <Image
          src={
            "https://ik.imagekit.io/ecellkiit/E-Cell%20Website/logo.png?updatedAt=1755075880371"
          }
          alt="logo"
          width={100}
          height={100}
